...
################### C scores ################### 
CSR.Person.C <- cor(CSRTraitEnvi_PerCor_df_log_scale[,c(1,4:44)]) # method = "spearman"
CSR.Person.C
...
################### S scores ################### 
CSR.Person.S <- cor(CSRTraitEnvi_PerCor_df_log_scale[,c(2,4:44)]) # method = "spearman"
CSR.Person.S
...
################### R scores ################### 
CSR.Person.R <- cor(CSRTraitEnvi_PerCor_df_log_scale[,c(3,4:44)]) # method = "spearman"
CSR.Person.R
